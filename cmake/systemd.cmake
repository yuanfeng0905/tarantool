...
if (NOT DEFINED WITH_SYSTEMD OR WITH_SYSTEMD)
    ...
    if (PKG_CONFIG_FOUND)
        pkg_search_module(SYSTEMD REQUIRED libsystemd libsystemd-daemon)
    endif()
endif()
...
if (WITH_SYSTEMD)
    ...
    if (NOT SYSTEMD_INCLUDE_DIR)
        message(STATUS "Systemd includes aren't found")
    else()
        set(HAVE_SD_NOTIFYF TRUE)
        message(STATUS "Found systemd includes: ${SYSTEMD_INCLUDE_DIR}/systemd/sd-demon.h")
    endif()
    if (NOT SYSTEMD_LIBRARIES)
        message(STATUS "Systemd libraries aren't found")
    else()
        message(STATUS "Found systemd library: ${SYSTEMD_LIBRARIES}")
    endif()
endif()
