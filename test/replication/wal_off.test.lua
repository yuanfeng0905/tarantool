...
while box.info.replication[wal_off_id].applier.message ~= check do fiber.sleep(0) end
box.info.replication[wal_off_id].status
box.info.replication[wal_off_id].applier.status
box.info.replication[wal_off_id].applier.message
box.cfg { replication = "" }
